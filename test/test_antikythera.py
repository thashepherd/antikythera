...
def test_add_rotor_exception():
    ...
    rotor = Rotor({0: [1, 2, 3, 4], 1: [5, 6, 7, 8], 2: [9, 10, 11, 12]})
    ...
    assert (
        str(excinfo.value) == "Added rotor has 4 columns but this puzzle is set for 3"
    )
...
def test_add_rotor_max_rotors():
    ...
    rotor1 = Rotor({0: [1, 2, 3], 1: [4, 5, 6], 2: [7, 8, 9]})
    rotor2 = Rotor({0: [10, 11, 12], 1: [13, 14, 15], 2: [16, 17, 18]})
    rotor3 = Rotor({0: [19, 20, 21], 1: [22, 23, 24], 2: [25, 26, 27]})
